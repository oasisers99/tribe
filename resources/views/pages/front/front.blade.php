			...
			<div class="container">
				<div class="row p-b">
					<div class="col-md-6 col-md-offset-3 text-center">
						...
						<p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">Explore what tribes are out there that fit your interest and area. Look around their projects and ask for join!</p>
					</div>
				</div>
				<div class="row p-b">
